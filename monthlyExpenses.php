...
<body>
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="panel panel-default">
					<div class="panel-heading">Monthly Expenses
    ...
    echo $msg;
            ...
            <table class="table table-bordered mg-b-0 table-data">
			  ...
			  $cdate=date('Y-m-d');
$ret=mysqli_query($con,"select * from tblexpense where UserId='$userid' AND ExpenseDate BETWEEN '$lastdate' AND '$cdate'");
$cnt=1;
...
<script>
    ...
    xmlhttp.open("GET","search-data-monthly-expenses.php?q="+value,true);
    xmlhttp.send();
  }
