	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Dashboard For Expenses</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Dashboard For Expenses</h1>
			</div>
		</div><!--/.row-->
...
echo $sum_monthly_expense;
	...
	?></span></div>
			...
			<div class="row">
				...
				<a href="CurrentYearExpenses.php">
				<div class="col-xs-6 col-md-3">
				<div class="panel panel-default">
					<?php
//Yearly Expense
