...
if($q=="")
{
    $query="select * from tblexpense where UserId='$userid' AND ExpenseDate='$tdate'";
}
 else
 {
   $query="select * from tblexpense where UserId='$userid' AND ExpenseDate='$tdate' AND ExpenseItem LIKE '$q%' OR ExpenseCost LIKE '$q%' OR ExpenseDate LIKE '$q%'";
 }
   $display_string="";
